...
class Libvmi:
    ...
    def __init__(self, domain, init_flags=INIT_DOMAINNAME, init_data=ffi.NULL, mode=VMIConfig.GLOBAL_FILE_ENTRY, config=ffi.NULL):
        self.vmi = None
        ...
        if init_flags & INIT_DOMAINNAME:
            domain = domain.encode()

        # same for VMI_CONFIG_STRING
        if mode == VMIConfig.STRING:
