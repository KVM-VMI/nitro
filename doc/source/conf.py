...
# -*- coding: utf-8 -*-
#
# nitro documentation build configuration file, created by
# sphinx-quickstart on Mon Aug  7 13:08:35 2017.
#
...
man_pages = [
    (master_doc, 'nitro', 'nitro Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'nitro', 'nitro Documentation',
     author, 'nitro', 'One line description of project.',
     'Miscellaneous'),
]
